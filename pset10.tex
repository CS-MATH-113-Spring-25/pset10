...
\section*{Problems}
In the following problem set assume all the graphs are simple and finite unless specfified otherwise.
\begin{questions}
  ...
  \question In this problem we will see how a lot of our theorems and intuition breaks when it comes to infinite graph.
  \begin{parts}
  ...
  \begin{figure}[h!]
    \centerline{\includegraphics[scale = 0.075]{digimonadventure.png}}
